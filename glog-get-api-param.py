...
parser.add_argument("-q","--glog_api-query", help="podaj kwerende API systemu Graylog", default="")
...
if args.glog_api-query == "":
    ...
    glog_api-query = args.glog_api-query

glogurl = glog_proto + "://" + glog_host + ":" + glog_port + glog_api-query
